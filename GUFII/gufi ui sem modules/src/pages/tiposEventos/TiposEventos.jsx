...
import lixo from '../../assets/img/trash-alt-regular.svg';
                                        ...
                                        this.state.listaTiposEventos.map((tipoEvento) => {
                                            return (
                                                <tr key={tipoEvento.idTipoEvento}>
                                                    ...
                                                    {/* <button onClick={() => this.exlcuirTipoEvento(tipoEvento)}>Excluir</button> */}
                                                    {/* <button onClick={() => this.buscarTipoEventoPorId(tipoEvento)}>Editar</button> */}
                                                    {/* Faz a chamada da função buscarTipoEventoPorId passando o Tipo de Evento selecionado como parâmetro */}
                                                    <td>
                                                    <img src={edit} onClick={() => this.buscarTipoEventoPorId(tipoEvento)} className="edit-icon" alt="" />
                                                    <img src={lixo} onClick={() => this.this.exlcuirTipoEvento(tipoEvento)} className="edit-icon" alt="" />
                                                    </td>
                                                </tr>
                                            )
                                        })
